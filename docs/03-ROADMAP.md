...
W1-A as a separate app/test project with document lifetime, TXT/RTF persistence, atomic saves, recent
files, a live Backstage/QAT file-command shell and a tested formatting/selection-state engine rather
than another Showcase page. Its
