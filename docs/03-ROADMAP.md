...
> **Progress (2026-08-08):** Phases 0–5 and **7 are complete**. Phase 6 is mostly done — **all five themes now ship** (2024, 2019, 2013, 2010 and 2007 — see [`04-DESIGN-NOTES.md`](../04-DESIGN-NOTES.md) §3.38 and [`07-OFFICE-2007-THEME-PLAN.md`](07-OFFICE-2007-THEME-PLAN.md)), per-monitor DPI is verified at 100/125/150/175/200% **on all five, 2007 included**, and every generation has a dark/black variant. The deterministic 40-image theme/variant × DPI suite covers ten palettes at 100/125/150/200% (§§3.48–3.49); seven focused approvals cover RTL, Office 2010 states/Backstage and classic-dark application menus, for 47 total. The context-menu, Customize/Options, chrome-tooltip, default-File and conventional application-menu-footer slices (§§3.52–3.56) move RibbonKit-owned shell text into `.resx`, expose live partial overrides, and cover RTL popup/action direction; §3.57 keeps the marker/notch aligned when localized File text changes width, §3.58 completes the representative bidirectional-content pass, §3.59 fixes live RTL Backstage flow, slide direction, and title-transition coordinates, and §3.60 makes the lab follow the Showcase's Backstage/application-menu/orb policy with representative bidirectional 2007-menu content. Broader RTL popup/window verification is still owed. Phase 8 has not started. Post-v1 MDI emulation is unusually shaped: M0 and M4 are done, M1–M3 are not.
>
...
Office 2019 (+dark/accents), 2013, 2010, 2007 themes on the token layer; visual regression snapshot suite per theme; DPI matrix testing (100/125/150/200%, mixed monitors, per-monitor v2); RTL verification; localization resources. **Exit criteria:** snapshot suite green across 5 themes × 4 DPI levels. *All five themes ship (2007 landed 2026-07-27, §3.38), every generation now has a dark/black palette (§3.49), and the deterministic 40-image theme/variant × DPI matrix is green locally. Seven focused scenes bring the total to 47 approvals. The context-menu, Customize/Options, chrome-tooltip, default-File and conventional application-menu-footer localization slices are complete (§§3.52–3.56), localized File-width reflow is fixed (§3.57), the representative bidirectional-content pass is pinned in a real RTL Backstage (§3.58), its live adorner/title transition now mirrors correctly (§3.59), and the lab mirrors the Showcase File-surface policy with a bidirectional 2007 menu (§3.60); broader popup/window verification is still owed.*
