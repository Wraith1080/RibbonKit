...
> **Progress (2026-08-02):** Phases 0–5 and **7 are complete**. Phase 6 is mostly done — **all five themes now ship** (2024, 2019, 2013, 2010 and 2007 — see [`04-DESIGN-NOTES.md`](../04-DESIGN-NOTES.md) §3.38 and [`07-OFFICE-2007-THEME-PLAN.md`](07-OFFICE-2007-THEME-PLAN.md)), per-monitor DPI is verified at 100/125/150/175/200% **on all five, 2007 included**, and every generation has a dark/black variant. The deterministic 40-image theme/variant × DPI suite covers ten palettes at 100/125/150/200% (§§3.48–3.49); six focused approvals cover RTL, Office 2010 states/Backstage and classic-dark application menus, for 46 total. The context-menu, Customize/Options, chrome-tooltip, default-File and conventional application-menu-footer slices (§§3.52–3.56) move RibbonKit-owned shell text into `.resx`, expose live partial overrides, and cover RTL popup/action direction; §3.57 keeps the marker/notch aligned when localized File text changes width. Full RTL popup/window verification and representative bidirectional content are still owed. Phase 8 has not started. Post-v1 MDI emulation is unusually shaped: M0 and M4 are done, M1–M3 are not.
>
