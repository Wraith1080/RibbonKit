...
RibbonKit Writer is implemented through W0-D and W1-A: application/test scaffold, document lifetime,
TXT/RTF persistence, atomic saves, recent files, a live Backstage/QAT file-command shell with
dirty-title and unsaved-close protection, and a tested formatting/selection-state engine over the
native `RichTextBox`. W1-B through W5 remain. See the [roadmap](docs/03-ROADMAP.md) and [design
