...
- Roadmap phases 0-5 and 7 are complete. All five themes (Office 2007, 2010, 2013, 2019, and 2024) ship, dark variants ship for Office 2019/2024, and DPI was verified at 100/125/150/175/200%. The deterministic 28-image snapshot matrix covers every light theme plus both dark variants at 100/125/150/200%, with one additional Office 2024 RTL smoke image. Phase 6 still owes full RTL verification and localization. Phase 8/API freeze has not started.
...
- The test suite has 122 green logic tests plus one visual test covering 29 approved images as of 2026-08-02. Phase 7 merge/modal invariants, nested dark-foreground/control-surface template contracts, and a first RTL layout smoke scene are covered; important remaining gaps include broader customization round trips, KeyTip resolution, and remaining reduction-algorithm cases.
