...
- RibbonKit is an MIT-licensed, Office Fluent UI-style WPF control library for `net8.0-windows` and `net9.0-windows`, with a local `v1.0.0` GitHub-release candidate. Public distribution is deferred until explicitly requested; NuGet.org publication is not planned.
