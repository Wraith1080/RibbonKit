...
public class RibbonTabControl : TabControl
{
    ...
    private readonly HashSet<RibbonTab> _observedTabs = [];
    ...
    protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
    {
        ...
        if (element is RibbonTab tab && _observedTabs.Add(tab))
        {
    ...
    {
        if (element is RibbonTab tab && _observedTabs.Remove(tab))
        {
            tab.IsVisibleChanged -= OnTabIsVisibleChanged;
        }
    ...
    {
        // A tab added, removed, moved, or revealed can shift the selected header without changing
        // this control's size or selection. Container preparation tracks visibility for both
        // direct RibbonTab items and containers generated by an ItemsSource.
